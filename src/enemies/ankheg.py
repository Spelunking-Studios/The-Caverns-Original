...
class Ankheg(Beetle):
    """A Boss-worthy beetle that shoots acid and stomps on anything in its sight"""
    ...
    def make_body(self):
        ...
        names = ["head", "body", "body2", "butt"]
        self.images = [
           pygame.image.load(asset("enemies/ankheg/ankheg-" + name + ".png")) for name in names 
        ]
        self.animations = [
