...
class Ball(Sprite):
    ...
    """
    def __init__(self, owner, radius = 10, pos = (20, 20), mass=100, moment=100):
        super()
        self.owner = owner
...
class Chain(Sprite):
    ...
    def create(self):
        ...
        for i in range(self.length):
            ball = Ball(self.owner, self.ball_radius ,(x + i*self.link_distance, y + i*self.link_distance), self.ball_weight)
